classdef hfss_app_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        NumberofIterationSpinner       matlab.ui.control.Spinner
        NumberofIterationSpinnerLabel  matlab.ui.control.Label
        Lamp                           matlab.ui.control.Lamp
        Label_3                        matlab.ui.control.Label
        PathtoHFSSAPIEditField         matlab.ui.control.EditField
        PathtoHFSSAPIEditFieldLabel    matlab.ui.control.Label
    ...
    methods (Access = private)
        ...
        function resetCallback(app, event)
            ...
            app.NumberofIterationSpinner.Value = 0;
        ...
        % Value changed function: PathtoHFSSAPIEditField
        ...
        function TargetValueChanged(app, event)
             if strcmp(app.PathtoHFSSAPIEditField.Value, '') == false && ...
                    strcmp(app.PathtoAnsysElectronicsEditField.Value, '') == false && ...
                    app.f_lowEditField.Value >= 0 && ...
                    app.f_highEditField.Value > app.f_lowEditField.Value && ...
                    app.NumberofIterationSpinner.Value > 0
                app.StartButton.Enable = 'on';
        ...
        function StartButtonPushed(app, event)
            ...
            hfsspath = app.PathtoHFSSAPIEditField.Value;
            ...
            maxIters = app.NumberofIterationSpinner.Value;        % max # of iterations.
            Accuracy = 0.01;      % accuracy required (1%).
            hasConverged = false;
            
            fprintf('The Initial Dipole Length is %.4f meter...\n', L);
            for iIters = 1:maxIters
                ...
                fprintf('The new estimate for the dipole length is %.4f meter\n', L);
            end
        ...
        % Value changed function: NumberofIterationSpinner
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.UIFigure.Position = [100 100 773 703];
            ...
            app.UIAxes.XGrid = 'on';
            app.UIAxes.YGrid = 'on';
            app.UIAxes.Position = [98 328 576 339];
            ...
            app.PathtoAnsysElectronicsEditFieldLabel.Position = [98 211 140 22];
            ...
            app.PathtoAnsysElectronicsEditField.Position = [253 211 359 22];

            % Create ResetButton
            app.ResetButton = uibutton(app.UIFigure, 'push');
            app.ResetButton.ButtonPushedFcn = createCallbackFcn(app, @resetCallback, true);
            app.ResetButton.Position = [253 29 100 23];
            ...
            app.f_targetEditFieldLabel.Position = [403 159 46 22];
            ...
            app.f_lowEditField.Position = [464 117 100 22];

            % Create MHzLabel
            app.MHzLabel = uilabel(app.UIFigure);
            app.MHzLabel.Position = [573 159 30 22];
            app.MHzLabel.Text = 'MHz';

            % Create MHzLabel_2
            app.MHzLabel_2 = uilabel(app.UIFigure);
            app.MHzLabel_2.Position = [573 72 30 22];
            app.MHzLabel_2.Text = 'MHz';

            % Create MHzLabel_3
            app.MHzLabel_3 = uilabel(app.UIFigure);
            app.MHzLabel_3.Position = [573 117 30 22];
            ...
            app.f_highEditFieldLabel.Position = [403 72 38 22];
            ...
            app.f_highEditField.Position = [464 72 100 22];
            ...
            app.AntennaModelDropDownLabel.Position = [98 159 86 22];
            ...
            app.AntennaModelDropDown.Position = [199 159 100 22];
            app.AntennaModelDropDown.Value = 'Dipole';

            % Create Label_2
            app.Label_2 = uilabel(app.UIFigure);
            app.Label_2.HorizontalAlignment = 'right';
            app.Label_2.Position = [622 210 25 22];
            app.Label_2.Text = '';

            % Create Lamp_2
            app.Lamp_2 = uilamp(app.UIFigure);
            app.Lamp_2.Position = [662 210 20 20];
            ...
            app.OpenModelfileButton.Enable = 'off';
            app.OpenModelfileButton.Position = [488 29 124 23];
            app.OpenModelfileButton.Text = 'Open Model file';

            % Create PathtoHFSSAPIEditFieldLabel
            app.PathtoHFSSAPIEditFieldLabel = uilabel(app.UIFigure);
            app.PathtoHFSSAPIEditFieldLabel.HorizontalAlignment = 'right';
            app.PathtoHFSSAPIEditFieldLabel.Position = [98 272 102 22];
            app.PathtoHFSSAPIEditFieldLabel.Text = 'Path to HFSS API';

            % Create PathtoHFSSAPIEditField
            app.PathtoHFSSAPIEditField = uieditfield(app.UIFigure, 'text');
            app.PathtoHFSSAPIEditField.ValueChangedFcn = createCallbackFcn(app, @PathtoHFSSAPIEditFieldValueChanged, true);
            app.PathtoHFSSAPIEditField.Placeholder = 'Insert path to the HFSS API by yuip here';
            app.PathtoHFSSAPIEditField.Position = [253 272 359 22];

            % Create Label_3
            app.Label_3 = uilabel(app.UIFigure);
            app.Label_3.HorizontalAlignment = 'right';
            app.Label_3.Position = [622 272 25 22];
            app.Label_3.Text = '';

            % Create Lamp
            app.Lamp = uilamp(app.UIFigure);
            app.Lamp.Position = [662 272 20 20];
            app.Lamp.Color = [0.9412 0.9412 0.9412];

            % Create NumberofIterationSpinnerLabel
            app.NumberofIterationSpinnerLabel = uilabel(app.UIFigure);
            app.NumberofIterationSpinnerLabel.HorizontalAlignment = 'right';
            app.NumberofIterationSpinnerLabel.Position = [98 117 108 22];
            app.NumberofIterationSpinnerLabel.Text = 'Number of Iteration';

            % Create NumberofIterationSpinner
            app.NumberofIterationSpinner = uispinner(app.UIFigure);
            app.NumberofIterationSpinner.Limits = [0 Inf];
            app.NumberofIterationSpinner.ValueChangedFcn = createCallbackFcn(app, @IterationValueChanged, true);
            app.NumberofIterationSpinner.Position = [221 117 100 22];
